<div>
    ...
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h3><?php echo e($isEdit ? 'Modifier' : 'Créer'); ?> un Utilisateur</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($isEdit && $existing_profile_image): ?>
                                        <div class="mb-2">
                                            <img src="<?php echo e(Storage::url($existing_profile_image)); ?>" 
                                                 alt="Photo actuelle"
                                                 class="rounded"
                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <h5>
                                ...
                                <?php echo e($isEdit ? 'Changer le Mot de Passe (optionnel)' : 'Mot de Passe *'); ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Mot de Passe <?php echo e($isEdit ? '' : '*'); ?></label>
                                    <input type="password" 
                                           wire:model="password" 
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Confirmer le Mot de Passe <?php echo e($isEdit ? '' : '*'); ?></label>
                                    <input type="password" 
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($user_type === 'proprietaire'): ?>
                        <div class="card mt-3">
                            <div class="card-header">
                                <h5>
                    ...
                    <?php elseif($user_type === 'locataire'): ?>
                        <div class="card mt-3">
                            <div class="card-header">
                                <h5>
                    ...
                    <?php elseif($user_type === 'demarcheur'): ?>
                        <div class="card mt-3">
                            <div class="card-header">
                                <h5>
                    ...
                    <div class="card mt-3">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <a href="<?php echo e(route('utilisateurs.liste')); ?>" class="btn btn-secondary">
                                ...
                                <button type="submit" 
                                    ...
                                    <span wire:loading.remove wire:target="saveUser">
                                        <i class="fa-solid fa-check me-2"></i><?php echo e($isEdit ? 'Mettre à jour' : 'Créer l\'utilisateur'); ?>
...
</div><?php /**PATH C:\wamp64\www\projets\starter-kit\resources\views/livewire/utilisateurs/creer-utilisateur.blade.php ENDPATH**/ ?>